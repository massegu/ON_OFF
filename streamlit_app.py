...
if visualizacion == "Mapa 2D":
    ...
    <br>
     Si el centro está iluminado y la periferia oscura (Centro ON), la célula se activa. <br> Si el centro está oscuro y la periferia iluminada (Centro OFF), también se activa, pero con polaridad inversa.
    ...
    <br><b> -Permite detectar bordes, contornos y transiciones de luminancia.</b><br>
